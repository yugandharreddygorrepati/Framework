 ...
 *
 */
public class EventListner1 implements WebDriverEventListener
{
	@Override
	...
	{
		// test.log(LogStatus.INFO, "afterNavigateTo()", "navigated to " + url +
		// " page title : " + arg.getTitle());
	...
	public void afterClickOn(WebElement element, WebDriver driver)
	{
		try
		{
			// test.log(LogStatus.INFO, "afterClickOn() ", "clicked on " +
			// element.getAttribute("outerHTML"));
			System.out.println("afterClickOn " + element);
		} catch (StaleElementReferenceException e)
		{
			// test.log(LogStatus.INFO, "afterClickOn()", "ignoring staleElement
